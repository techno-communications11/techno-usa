...
const Page = () => {
  ...
  const contactMethods = [
    { icon: <FaMapMarkerAlt className="text-2xl text-blue-600" />, title: "Our Headquarters", info: "6464 Savoy Dr, Suite 215, Houston, TX 77036", link: "https://goo.gl/maps/6m2abb9adf339d56" },
    { icon: <FaPhone className="text-2xl text-purple-600" />, title: "Phone Number", info: "+1(713) 640-5426", link: "tel:+7136405426" },
    { icon: <FaEnvelope className="text-2xl text-blue-600" />, title: "Email Address", info: "info@techno-communications.com", link: "mailto:info@techno-communications.com" },
  ];

  const subBranches = [
    { name: "Houston Headquarters", address: "6464 Savoy Dr, Suite 215, Houston, TX 77036", link: "https://goo.gl/maps/6m2abb9adf339d56", bgColor: "bg-[#E0F2FE]", hoverColor: "hover:bg-[#38BDF8]", textColor: "text-[#1E3A8A]", image: "/houston.jpg" }, // Replace with actual image path
    { name: "India Office", address: "123 Tech Park, Bengaluru, Karnataka 560001", link: "https://goo.gl/maps/example-india", bgColor: "bg-[#F3E8FF]", hoverColor: "hover:bg-[#A78BFA]", textColor: "text-[#4C1D95]", image: "/india.jpg" }, // Replace with actual image path
    { name: "Pakistan Office", address: "456 Tech Hub, Karachi, Sindh 75500", link: "https://goo.gl/maps/example-pakistan", bgColor: "bg-[#D1FAE5]", hoverColor: "hover:bg-[#34D399]", textColor: "text-[#065F46]", image: "/pakistan.jpg" }, // Replace with actual image path
    { name: "Dubai Office", address: "789 Business Bay, Dubai, UAE", link: "https://goo.gl/maps/example-dubai", bgColor: "bg-[#FEF3C7]", hoverColor: "hover:bg-[#FBBF24]", textColor: "text-[#92400E]", image: "/dubai.jpg" }, // Replace with actual image path
  ];

  const showToast = (message, type) => setToast({ message, type, visible: true });
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-12">
              <form className="space-y-6" onSubmit={handleSubmit}>
                {error && !success && <p className="text-red-600 text-sm font-medium">{error}</p>}
